  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Default state
        !isDragging && "border-gray-300 bg-gray-50/50",
        // Dragging acceptable type (ready to receive)
        isDragging && isAcceptable && !isOver && "border-blue-300 bg-blue-50/30 animate-pulse",
        // Dragging non-acceptable type
        isDragging && !isAcceptable && !isOver && "border-gray-300 bg-gray-100/50 opacity-50",
