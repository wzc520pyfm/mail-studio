    ...
    <Dialog>
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Configure email metadata, fonts, and global styles.</DialogDescription>
        </DialogHeader>
        ...
        <ScrollArea className="max-h-[60vh]">
          <div className="space-y-6 pr-4">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">Add Google Fonts or other web fonts</p>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">Additional CSS styles for the email</p>
            </div>
          </div>
        </ScrollArea>
      </DialogContent>
